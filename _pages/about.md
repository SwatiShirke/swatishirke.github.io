...
I am a graduate student of Robotics engineering at Worcester Polytechnic Institute (WPI). My area of interest is Sensor Data Processing and integration of Robotic Control with Reinforcement Learning (RL). 

My current research work is on a multi-agent RL framework for collaborative decision-making of an AV fleet in urban traffic scenarios under the guidance of Prof. Siavash Farzan at WPI. Our goal is to substitute the existing non-adaptive intersection control method with intelligent RL policies utilizing the MAA2C algorithm. 

My coursework and projects have given me valuable exposure to Computer Vision (CV), Robot Control and RL. As part of my coursework for CV, I have implemented 3D scene reconstruction with Structure from Motion (SfM) & Neural Radiance Fields (NeRF), edge detection, feature extraction & matching, panorama stitching and camera calibration. I am learning to implement different CV techniques using both mathematical and deep learning approaches. I have also worked on state estimation using the Kalman filter.[Here](https://github.com/SwatiShirke)
